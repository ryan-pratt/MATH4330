...
def subtract_vectors(vector_a, vector_b):
    ...
    This takes two vectors, as lists, of equal length, computes their difference,
    and returns that difference as a list by adding the negation of vector_b to vector_a.
...
def orthogonal_decomposition(orthonormal_set, vector):
    ...
    This computes the orthogonal decomposition of a vector with respect to orthonormal_set

    Args:
        orthonormal_set (list of lists): orthonormal list of vectors
        vector (list): a vector of compatible dimension to the vectors in orthonormal_set
...
def multiply_matrices(matrix_a, matrix_b):
    ...
    This computes the multiplication of two matrices by computing the dot product
    of each column of the first matrix with each column of the second matric.
